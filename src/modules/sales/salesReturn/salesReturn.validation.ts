...
const salesReturnBaseSchema = z.object({
  ...
  salesReturnDate: z.union([z.string(), z.date()]).default(() => new Date().toISOString()),
...
export const salesReturnSchema = salesReturnBaseSchema
.refine((data) => {
